...
if ($count == 0) {
  ...
  $sql = "SELECT Name, Source, Destination, Departure, Arrival, Fair_Economic, Fair_Business, Fair_VIP, Available_seats FROM flights WHERE Id = $flight_id";
  ...
  <ul>
    ...
    <li style="float: left;  font-weight:bold;color:black;font-family: sans-serif;font-size: 43px;">AIRLINE MANAGEMENT SYSTEM</li>
  </ul>
  ...
  <div class="wrapper">
    <form action="updateflight3.php" method="post">
      ...
      Total Seats: <input type="number" name="Available_seats" value="<?php echo $row['Available_seats']; ?>" required></input><br><br>
